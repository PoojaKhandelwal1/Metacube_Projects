define(['Routing_AppJs_PK'], function (Routing_AppJs_PK) {
    ...
    Routing_AppJs_PK.filter('CustomMakeSortData', [function () {
        function getPriority(item, SearchItem, type) {
        ...
        return function (items, SearchItem, type) {
            ...
            filtered.sort(function (a, b) {
                if (SearchItem != '') {
                    first = getPriority(a, SearchItem, type);
                    second = getPriority(b, SearchItem, type);
                    if (first > second) {
                        return -1;
