define(['Routing_AppJs_PK'], function(Routing_AppJs_PK) {
    Routing_AppJs_PK.directive('custpriceOnlyInput', [function() {
        return {
            restrict: 'EA',
            template: '<input id="{{idValue}}" type="text" rel="{{relValue}}" class="{{classValue}} " ng-attr-tabindex="{{tabIndex}}" ng-disabled="packaged==false" placeholder="{{placeHolderValue}}" ng-model="inputValue" ng-focus="focusValue()" ng-blur="blurValue({event: $event});setPrecision();" ng-change="validatePriceInput()" ng-class="{\'redborder\' : validationModal[validationModalKey][\'isError\'] == true}" data-toggle="tooltip" title="{{validationModal[validationModalKey][\'ErrorMessage\']}}"/>',
            scope: {
                idValue: '@',
                classValue: '@',
                placeHolderValue: '@',
