...
angular.module('signature').directive('signaturePad', ['$interval', '$timeout', '$window',
  function ($interval, $timeout, $window) {
    ...
    return {
      restrict: 'EA',
      replace: true,
      //template: '<div class="signature" style="width: 657px; display:block; max-width:{{width}}px; height: 268px; max-height:{{height}}px;"><canvas style="display: block; background:white;width: 657px;height: 268px; " ng-mouseup="onMouseup()" ng-mousedown="notifyDrawing({ drawing: true })"></canvas></div>',
      template: '<div class="signature" style="width: 100%; max-width:{{width}}px; height: 100%; max-height:{{height}}px;"><canvas style="display: block; margin: 0 auto;background:white;width: 100% !important; height: 100% !important; " ng-mouseup="onMouseup()" ng-mousedown="notifyDrawing({ drawing: true })"></canvas></div>',
